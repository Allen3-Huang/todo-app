...
import { useTodoStore, selectActiveCount, selectHasCompleted, selectTotalCount, selectIsMaxTodoReached } from '../../stores/todoStore'
...
export function TodoApp() {
  ...
  const isMaxTodoReached = useTodoStore(selectIsMaxTodoReached)
  ...
  return (
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        <TodoInput onAdd={addTodo} disabled={isMaxTodoReached} />
        <TodoList
          todos={todos}
          onToggle={toggleTodo}
