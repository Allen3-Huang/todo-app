...
import { useTodoStore, selectActiveCount, selectHasCompleted, selectTotalCount, selectCanAddTodo } from '../../stores/todoStore'
...
export function TodoApp() {
  ...
  const canAddTodo = useTodoStore(selectCanAddTodo)
  ...
  return (
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        <TodoInput onAdd={addTodo} disabled={!canAddTodo} />
        <TodoList
          todos={todos}
          onToggle={toggleTodo}
